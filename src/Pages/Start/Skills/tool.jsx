function Tool({ tool, smalltool = false }) {
  return (
    <a href={tool.link} target="_blank" >
      <div className="rounded-lg  bg-green-calid bg-opacity-60 flex place-content-center place-items-center py-2 px-4 gap-5 hover:bg-opacity-15" data-aos="flip-up">
